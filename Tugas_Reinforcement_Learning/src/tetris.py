...
class Tetris:
    ...
    def render(self, video=None):
        ...
        cv2.putText(img, "Hasil:", (self.width * self.block_size + int(self.block_size / 2), self.block_size),
        ...
        cv2.putText(img, "Balok:", (self.width * self.block_size + int(self.block_size / 2), 4 * self.block_size),
                    fontFace=cv2.FONT_HERSHEY_DUPLEX, fontScale=1.0, color=self.text_color)
        cv2.putText(img, str(self.tetrominoes),
                    (self.width * self.block_size + int(self.block_size / 2), 5 * self.block_size),
                    fontFace=cv2.FONT_HERSHEY_DUPLEX, fontScale=1.0, color=self.text_color)

        cv2.putText(img, "Baris:", (self.width * self.block_size + int(self.block_size / 2), 7 * self.block_size),
                    fontFace=cv2.FONT_HERSHEY_DUPLEX, fontScale=1.0, color=self.text_color)
        ...
        cv2.imshow("deep Qlearning-game tetris", img)
        cv2.waitKey(1)
